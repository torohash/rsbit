...
const PATH: &'static str = "/v5/order/realtime";

impl BybitApi {
    /// Retrieves the open order information based on the provided parameters.
    ///
    /// # Arguments
    ///
    /// * `params` - The parameters for retrieving open orders.
    ///
    /// # Examples
    ///
    /// ```rust
    /// use rsbit::v5::api::{
    ///     get::trade::get_open_orders::{
    ...
    ///     let params = GetOpenOrdersParameters::new(GetOpenOrdersCategory::Linear).with_symbol("BTCUSDT".to_string());
    ///     let response = api.get_open_orders(params).await;
    ///     match response {
    ///         Ok(info) => {
    ///             // Handle the data
    ///         },
    ...
    /// }
    /// ```
    pub async fn get_open_orders(&self, params: GetOpenOrdersParameters) -> Result<GetOpenOrdersResponse> {
...
pub enum GetOpenOrdersCategory {
    Linear,
    Inverse,
    Option,
    Spot,
...
#[derive(Debug, Clone, Serialize)]
#[serde(rename_all = "camelCase")]
pub struct GetOpenOrdersParameters {
    category: GetOpenOrdersCategory,
...
impl GetOpenOrdersParameters {
    /// Creates a new instance of `GetOpenOrdersParameters` with the specified category.
    ///
    /// # Arguments
    ///
    ...
    /// # Returns
    ///
    /// A new instance of `GetOpenOrdersParameters`.
    pub fn new(category: GetOpenOrdersCategory) -> Self {
        Self {
            category,
            symbol: None,
            base_coin: None,
    ...
    /// Sets the symbol for the open orders parameters.
    ///
    /// # Arguments
    ///
    ...
    /// # Returns
    ///
    /// The modified `GetOpenOrdersParameters` instance.
    pub fn with_symbol(mut self, symbol: String) -> Self {
        self.symbol = Some(symbol);
        self
    }

    /// Sets the base coin for the open orders parameters.
    ///
    /// # Arguments
    ///
    ...
    /// Sets the settle coin for the open orders parameters.
    ///
    /// # Arguments
    ///
    ...
    /// Sets the order id for the open orders parameters.
    ///
    /// # Arguments
    ///
    ...
    /// Sets the order link id for the open orders parameters.
    ///
    /// # Arguments
    ///
    ...
    /// Sets the open only for the open orders parameters.
    ///
    /// # Arguments
    ///
    /// * `open_only` - The open only to set.
    ///
    /// # Returns
    ///
    /// The modified `GetOpenOrdersParameters` instance.
    pub fn with_open_only(mut self, open_only: u8) -> Self {
        self.open_only = Some(open_only);
        self
    }

    /// Sets the order filter for the open orders parameters.
    ///
    /// # Arguments
    ///
    ...
    /// Sets the limit for the open orders parameters.
    ///
    /// # Arguments
    ///
    ...
    /// Sets the cursor for the open orders parameters.
    ///
    /// # Arguments
    ///
...
impl GetOpenOrdersResponse {
    ...
    pub fn result(&self) -> &OpenOrdersResult {
        &self.result
    }

    pub fn set_result(&mut self, result: OpenOrdersResult) {
        self.result = result;
    }
...
impl OpenOrdersResult {
    ...
    pub fn list(&self) -> &Vec<OpenOrder> {
        &self.list
    }

    pub fn set_list(&mut self, list: Vec<OpenOrder>) {
        self.list = list;
    }
}
