...
pub struct LinearTickersResult {
    list: Vec<LinearTickers>,
}
impl LinearTickersResult {
    pub fn list(&self) -> &Vec<LinearTickers> {
        &self.list
    }

    pub fn set_list(&mut self, list: Vec<LinearTickers>) {
        self.list = list;
    }
}
